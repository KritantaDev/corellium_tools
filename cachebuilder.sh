...
## Author: kritanta (gh: KritantaDev, tw: @arm64e)
## Licensed under CC0
...
# this script essentially runs like assembly. send complaints to @arm64e on twitter.
...
stat "$TDIR/Info.plist" > /dev/null 2>&1 || curl -s https://gist.githubusercontent.com/KritantaDev/5dbe177c255c3578370afa42e15e8e64/raw/9c02aff7ea216cff3d1f7da09bcb5a05752e77c6/cacheplaceholder > "$TDIR/Info.plist"
